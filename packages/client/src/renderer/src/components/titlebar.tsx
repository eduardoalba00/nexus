...
export function Titlebar() {
  ...
  return (
    <div className="flex h-8 items-center justify-between bg-background border-b border-border select-none">
      <div
      ...
      <div className="flex" style={{ WebkitAppRegion: "no-drag" } as React.CSSProperties}>
        <button
          ...
          className="inline-flex items-center justify-center w-11 h-8 hover:bg-secondary transition-colors"
        >
        ...
        <button
          ...
          className="inline-flex items-center justify-center w-11 h-8 hover:bg-destructive transition-colors"
        >
